...
--beautiful.init(gears.filesystem.get_themes_dir() .. "neon/theme.lua")
local theme_dir = "~/.config/awesome/themes/"
beautiful.init(theme_dir .. "neon/theme.lua")
...
mymainmenu = awful.menu({ items = { { "Awesome", myawesomemenu, beautiful.awesome_icon },
                                    { "Launch Applications", function() awful.spawn.with_shell("rofi -normal-window -modi drun -show drun -theme " .. theme_dir .. "neon/rofi.rasi") end },
...
globalkeys = gears.table.join(
    ...
    -- Menubar
    awful.key({ modkey }, "d", function() awful.spawn.with_shell("rofi -normal-window -modi drun -show drun -theme " .. theme_dir .. "neon/rofi.rasi") end,
